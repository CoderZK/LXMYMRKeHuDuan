...
- (void)setModel:(LxmJiFenModel *)model  {
    ...
    if (type == 1) {
        self.titleLB.text = [NSString stringWithFormat:@" 来自-%@直属业绩小煜%@",model.by_name,@""];
        ...
        [self.typeBt setImage:[UIImage imageNamed:@"kk940"] forState:UIControlStateNormal];
        self.typeBt.titleLabel.font = [UIFont systemFontOfSize:10];
        [self.typeBt setTitle:[NSString stringWithFormat:@" 收入小煜 = 销售业绩 x %0.1f%% - 下级分配",model.sale_rate.doubleValue * 100] forState:UIControlStateNormal];
