...
//         [messageStr appendAttributedString:messageImageStr];
    ...
    if (model.suType.intValue == 1 || model.su_type.intValue == 1) {
        NSAttributedString *messageTextStr = [[NSAttributedString alloc] initWithString:messageText attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10],NSForegroundColorAttributeName:MainColor}];
